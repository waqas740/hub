...
const init = {
    createControlerFolder: force => {
        createFolder('controllers', path.resolve(process.cwd(), "controllers"), force);
    },

    createRouteFolder: force => {
        createFolder('routes', path.resolve(process.cwd(), "routes"), force);
    },

    createModelsFolder: force => {
        createFolder('models', path.resolve(process.cwd(), "models"), false);
    },
